        ...
        <div className="w-screen h-screen pl-[6vw] pr-[2vw] bg-secondary">
            <div className="h-[40vh] flex justify-between items-center">
                <div className="w-[50vw] flex flex-col gap-[5vh] ">
                    <p className={abyssinica.className + " text-[clamp(25px,3.5vw,48px)] text-primary"}>Welcome, bǎobèi !</p>
                    <p className={nanum.className + " text-[clamp(16px,1.8vw,30px)] text-primary text-justify leading-10"} >We are so happy to have you join our cozy little corner of deliciousness.</p>
                </div>
            ...
            <div className="h-[60vh]">
                ...
                <div className="flex justify-between items-center py-3" >
                    <p className={nanum.className + " text-[clamp(16px,1.8vw,30px)] text-primary text-justify "} >Open daily : 11 AM to 9 PM</p>
                    <p className={nanum.className + " text-[clamp(16px,1.8vw,30px)] text-primary text-justify "} >12 * 85 st, Mandalay</p>
                </div>
            </div>
        </div>
    )
